...
\begin{tablenotes}
\small
\item [*] ESS : Epworth Sleepiness Scale
\item [\dag] CPAP : Continuous Positive Airway Pressure
\end{tablenotes}
\end{threeparttable}
\end{table}
\end{landscape}
...
\bottomrule
\multicolumn{4}{l}{\textsuperscript{*} Data are presented as mean (95\% confidence interval) of bootstrap iterations}\\
\end{tabular}}
\end{table}
\clearpage
\begin{table}[H]

\caption{\label{tab:Wheight_coefficients}Table caption \label{tab:example}}
\centering
...
\bottomrule
\multicolumn{4}{l}{\textsuperscript{1} Data are presented as mean (95\% confidence interval) of bootstrap iterations}\\
\end{tabular}
\end{table}
\clearpage
...
\endfoot
\bottomrule
\multicolumn{2}{l}{\rule{0pt}{1em}\textsuperscript{*} Data are presented as mean (95\% confidence interval) of bootstrap iterations}\\
\endlastfoot
